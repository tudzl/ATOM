...
#V1.6 13.07.2020 test for 16BV demo, ATOM Matrix+RFID unit
##bugs when detect tag, program crashes!
#V1.5b 09.07.2020 test for 16BV demo
...
print('< Author: Ling.Zell, li.zhou@staubli.com, 13.July.2020 >'+"\r\n");
...
def buttonA_wasPressed():
  ...
  if TAG_near:
     print('#-->:RFID write data to TAG Block5: 15BV'+"\r\n") #block stars from 0, avoid 3,7( keys)!
     stat=rfid0.writeBlock(5,'16BV_0001')
     if stat== OK:
       print('#-->:RFID write Block5 successful')
       ...
       rgb.set_screen([0,0xff1a1a,0xff1a1a,0xff1a1a,0,0,0xff1a1a,0xe4ff1a,0xff1a1a,0,0,0xff1a1a,0xe4ff1a,0xff1a1a,0,0,0xff1a1a,0xe4ff1a,0xff1a1a,0,0,0,0xff1a1a,0,0])
       print('#-->:RFID write Block5 failed!')
     print('#-->:RFID write data to TAG Block6: 16BV'+"\r\n")
     stat=rfid0.writeBlock(6,'16BV')
     if stat== OK:
       print('#-->:RFID write Block6 successful')
       rgb.set_screen([0x0df21c,0,0x89e6cf,0,0x0df21c,0,0,0x0df21c,0,0,0x89e6cf,0x0df21c,0x0db3c9,0x0df21c,0x89e6cf,0,0,0x0df21c,0,0,0x0df21c,0,0x89e6cf,0,0x0df21c])
       
     else:
       rgb.set_screen([0,0xff1a1a,0xff1a1a,0xff1a1a,0,0,0xff1a1a,0xe4ff1a,0xff1a1a,0,0,0xff1a1a,0xe4ff1a,0xff1a1a,0,0,0xff1a1a,0xe4ff1a,0xff1a1a,0,0,0,0xff1a1a,0,0])
       print('#-->:RFID write Block6 failed!')
     wait_ms(100)
     rgb.setBrightness(5)
     #stat=rfid0.writeBlock(8,'16BV_009')
     #if stat== OK:
       #print('#-->:RFID write REG8 successful')
     #else:
       #print('#-->:RFID write REG8 failed!')
...
while True:
  ...
  if rfid0.isCardOn():
    ...
    rgb.set_screen([0,0xf9e834,0xf9e834,0xf9e834,0,0xf9e834,0,0,0,0xf9e834,0,0,0x9afd49,0,0,0xf934ce,0,0,0,0xf934ce,0,0xf934ce,0xf934ce,0xf934ce,0])
    print('Tag available!'+"\r\n")
    TAG_near = 1
    try:
      ...
      uart.write(str(RFID_ID)+',') #cost 5ms interval to 1st msg
      uart.write(str(TAG_Reg0)+"\r\n") #cost 2.5ms interval to above msg
      uart.write('#-->:Run_cnt:'+str(run_cnt)+"r\n")
    except:
