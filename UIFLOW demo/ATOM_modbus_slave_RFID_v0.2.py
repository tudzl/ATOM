...
def buttonA_wasPressed():
  ...
  #tmp_msg = bytes(var)
  #uart.write('9') 
  #uart.write(b'9')#same to uart.write('9')
  #uart.write(bytes(8))
  #tmp_msg = tmp_msg +1
  #uart.write(tmp_msg)
  #var = 9999
  #tmp_msg=str(hex(var))
  #tmp_msg = tmp_msg[2:].encode('ascii') # delete first 2 elements "0x"
  #tmp_msg = tmp_msg[2:].encode('ascii')  
  #uart.write('data2:')
  #uart.write(tmp_msg)
  print('Modbus msg sent:')
  print(str(tmp_msg))
  print("\r\n")
  print('data_payload:')
