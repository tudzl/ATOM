...
from uiflow import *
import machine
##Atom Matrix PWM G26(GROVE_pin3) demo v1.4##
#V1.4 buttonA_wasDoublePress improved, tested ok~ new Matrix APIKEY: 46CB92B9
...
def buttonA_wasDoublePress():
  ...
  if(DIR>0):
    rgb.set_screen([0,0,0xff0000,0,0,0,0xff0000,0xff0000,0xff0000,0,0xff0000,0,0xff0000,0,0xff0000,0,0,0xff0000,0,0,0,0,0xff0000,0,0])
  else:
    rgb.set_screen([0,0,0x0011ff,0,0,0,0,0x0011ff,0,0,0x0011ff,0,0x0011ff,0,0x0011ff,0,0x0011ff,0x0011ff,0x0011ff,0,0,0,0x0011ff,0,0])
  wait_ms(500)
  pass
...
print('Atom Matrix PWM G26(GROVE_pin3) demo v1.4')
