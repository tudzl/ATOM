...
def show_num_single(num):
    if (num == 0):
      ...
      rgb.set_screen([0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0,0,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0,0,0xFFFFFF,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0])
    elif (num == 4):
      rgb.set_screen([0,0,0,0xFFFFFF,0,0,0,0xFFFFFF,0xFFFFFF,0,0,0xFFFFFF,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0,0xFFFFFF,0])
    elif (num == 5):
      ...
      rgb.set_screen([0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0xFFFFFF,0,0,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0xFFFFFF,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0])
    elif (num == 7):
      rgb.set_screen([0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0,0,0xFFFFFF,0,0,0,0,0xFFFFFF,0,0,0,0,0xFFFFFF,0,0,0,0,0xFFFFFF,0])
    elif (num == 8):
      rgb.set_screen([0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0xFFFFFF,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0xFFFFFF,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0])
    elif (num == 9):
      rgb.set_screen([0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0xFFFFFF,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0,0,0,0,0xFFFFFF,0,0,0xFFFFFF,0xFFFFFF,0xFFFFFF,0])
...
while True:
  ...
  wait_ms(40)
  print(btnA.wasPressed())
  print(btnA.wasDoublePress())
